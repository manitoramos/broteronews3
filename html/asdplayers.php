...
border-radius: 70px;"/>
		...
		<div style="padding:10px;">
			...
			<h4 style="margin-top:7px;margin-bottom:5px"><a href="<?php echo $steamprofile2x;?>"><?php echo $rsx['username']; ?></a></h4>
...
<?php echo'<img style="margin-top:2px;max-width:78%" src="http://csgoevo.com/generateimage.php?per='.$generatechance.'" alt=""/>'; ?>
		</div>
		</div><br/>
