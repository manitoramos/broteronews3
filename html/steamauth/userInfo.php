<?php
	include("$_SERVER[DOCUMENT_ROOT]/CSGOJackpot_Simple_v1.4_CSGO.network/html/steamauth/settings.php");
    if (empty($_SESSION['steam_uptodate']) or $_SESSION['steam_uptodate'] == false or empty($_SESSION['steam_personaname'])) {
        ...
        $_SESSION['steam_personaname'] = htmlspecialchars($content['response']['players'][0]['personaname']);
